...
def configure_default_params(time_horizon: float) -> Hyperparameters:
    """Build ablation-study hyperparameters (no curriculum learning)."""
    ...
    params.training.generator_threshold_init = 0.0
    ...
    params.constraints.use_beta_ra_curriculum = False
