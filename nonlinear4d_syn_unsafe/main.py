...
from src.control_network import LinearControl4DNN # [control synthesis]
...
def main():
    ...
    params.network.input_scale = [6.0, 6.0, 6.0, 6.0]
    ...
    dynamics = Dynamics.dynamics(f=f_cl_module, g=g, state_dim=4)
    ...
    unsafe_range = np.vstack((unsafe_tb, unsafe_db, 
                              unsafe_fb, unsafe_bb,
                              unsafe_lb, unsafe_rb, unsafe_4b1, unsafe_4b2))
    ...
    unsafe_4b1 = Region(unsafe_4b1)
    unsafe_4b2 = Region(unsafe_4b2)
    unsafe = Region.union(unsafe_tb, unsafe_db, 
                          unsafe_fb, unsafe_bb,
                          unsafe_lb, unsafe_rb,
                          unsafe_4b1, unsafe_4b2)
