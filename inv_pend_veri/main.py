...
from src.control_network import WrapperConterlNN, TanhPolicy
...
def train_network_bounds(
    ...
    for epoch in range(params.training.num_epochs):
        ...
        if params.compute_GV:
            ...
            if((epoch + 1) % (REFINE_INTERVAL + 1) == 0):
        ...
        with torch.no_grad():
            ...
            if params.compute_V:
                ...
                outside_satisfied = (bounds_updated['outside'][0].min() >= 0)
...
def main():
    ...
    rl_policy_net = TanhPolicy(2, 1, 64)
